...
function f5() {
    const checkbox5 = document.querySelector('.i-5');
...
function f7() {
    ...
    document.querySelector('.out-71').innerHTML = a7;
    if (a7.length >= 6){
...
function f8() {
    ...
    out8.innerHTML += 'Input i-81 <input type="text" class="i-81"><br>';
...
function f19() {
    document.querySelector('.out-19').innerHTML = document.querySelector('.i-191').value;
    document.querySelector('.out-19').innerHTML += ' ';
    document.querySelector('.out-19').innerHTML += document.querySelector('.i-192').value;
...
function f20(e) {
    ...
    document.querySelector('.out-20').innerHTML = form.elements['username'].value;
    document.querySelector('.out-20').innerHTML += ' ';
    document.querySelector('.out-20').innerHTML += form.elements['password'].value;
