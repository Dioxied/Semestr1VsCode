...
function t6() {
    ...
    let b = parseInt(document.querySelector('.i-6').value);
    for(let i = 1; i < b+1; i++){
...
function t7() {
    let b = parseInt(document.querySelector('.i-7').value);
    for (let i = b; i > -1; i--){
...
function t8() {
    let b = parseInt(document.querySelector('.i-81').value);
    let c = parseInt(document.querySelector('.i-82').value);
    for (let i = b; i < c+1; i++){
...
function t9() {
    ...
    let a = parseInt(document.querySelector('.i-91').value);
    let b = parseInt(document.querySelector('.i-92').value);
    if (a > b){
        for (let i = b; i < a+1; i++){
...
function t14() {
    ...
    for (let i = 0; i < a.length; i++){
        if(a[i].checked){
            document.querySelector('.out-14').innerHTML = a[i].value;
        }
    }
