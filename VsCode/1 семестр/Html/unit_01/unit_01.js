...
document.querySelector(".three").innerHTML="<h3>Task 10</h3>";
...
document.querySelector(".four").innerHTML="<div></div>"
document.querySelector(".four").innerHTML+="<h4>Task 11 Hello World</h4>";
document.querySelector(".four").innerHTML+="<p>Это 11 задание по JS</p>"
